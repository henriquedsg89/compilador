...
public class TerminalToken extends SymbolToken
{
	public TerminalToken(int position, String value)
	{
		super(TokenId.TERMINAL, position, value);
	}
	
	public SimpleAttributeSet getStyle() 
	{
		if (getLexeme().startsWith("\""))
			return Style.STRING.getStyle();
		else
