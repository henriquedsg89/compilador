...
public class SemanticActionToken extends SymbolToken
{
	public SemanticActionToken(int position, String lexeme)
	{
		super(TokenId.SEMANTIC_ACTION, position, lexeme);
	}
	
	public SimpleAttributeSet getStyle() 
	{
		return Style.ACTION_SEM.getStyle();
	}
}
