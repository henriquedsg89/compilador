...
public class CommentaryToken extends IgnorableToken
{
	private String value;
	
	public CommentaryToken(int position, String value)
	{
		super(TokenId.COMMENT, position);
		this.value = value;
	}
